...
# 博物馆活动列表页网址
url = "http://www.xbpjng.cn/PlatNews/platform.aspx?c=e7702623-6881-4c16-a20e-258702f3437b"
...
links = [] #存取各个活动详情页网址
for tag in soup.find_all('ul', class_='newslist2'):
...
for kk in links:#遍历详情页链接
    ...
    for tag in Detailsoup.findAll('div', class_ = 'maintxt'):#详情页活动介绍正文
        ...
        for a in img_link:#遍历img字段
            ImgList.append("http://www.xbpjng.cn/PlatNews/platform.aspx?c=e7702623-6881-4c16-a20e-258702f3437b" + a['src'])#网页给的img链接没有"http://www.sxhm.com/"自己加上
...
dataframe.to_csv(r"西柏坡纪念馆.csv",sep=',')
