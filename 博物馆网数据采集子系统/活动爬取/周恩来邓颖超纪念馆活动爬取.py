...
# 博物馆活动列表页网址
url = "http://child.enorth.com.cn/system/2016/03/14/030862110.shtml"
...
for kk in links:#遍历详情页链接
    ...
    for tag in Detailsoup.findAll('div', class_ = 'maintxt'):#详情页活动介绍正文
        ...
        for a in img_link:#遍历img字段
            ImgList.append("http://child.enorth.com.cn/system/2016/03/14/030862110.shtml" + a['src'])#网页给的img链接没有"http://www.sxhm.com/"自己加上
...
dataframe.to_csv(r"周恩来邓颖超纪念馆.csv",sep=',')
