...
@WebServlet("/MuseumCollectionExplain")
public class MuseumCollectionExplain extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response){
        ...
        try {
            ...
            String CollectionID=res1.get(0).get("id");
            if (ExhibitionDB.Error()) {
                JR.put("STATUS","001");
                JR.put("Error","ExhibitionDB connection Error!");
                throw new Exception(JR.getString("Error"));
            ...
            sql="select * from MUSEUM.explain where collectionID="+CollectionID+" and type=3 and status=1;";
