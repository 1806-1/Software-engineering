...
url = "http://www.xbpjng.cn/PlatNews/platform.aspx?c=8c812025-0ca3-4ffb-80b0-1912dfe73c39"
...
for kk in links:
    ...
    for tag in Detailsoup.findAll('div', class_='maintxt'):
        ...
        for a in img_link:
            ImgList.append("http://www.xbpjng.cn/PlatNews/platform" + a['src'])
...
dataframe.to_csv(r"西柏坡纪念馆展览.csv", sep=',')
