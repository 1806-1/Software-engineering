...
# 博物馆活动列表页网址
url = "http://ln.people.com.cn/n2/2020/0707/c378489-34139606.html"
...
for kk in links:#遍历详情页链接
    ...
    for tag in Detailsoup.findAll('div', class_ = 'maintxt'):#详情页活动介绍正文
        ...
        for a in img_link:#遍历img字段
            ImgList.append("http://ln.people.com.cn/n2/2020/0707/c378489-34139606.html" + a['src'])#网页给的img链接没有"http://www.sxhm.com/"自己加上
...
dataframe.to_csv(r"“九·一八”历史博物馆.csv",sep=',')
