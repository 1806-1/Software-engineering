...
# 博物馆活动列表页网址
url = "https://www.dpm.org.cn/gugongforum.html"
...
for kk in links:#遍历详情页链接
    ...
    for tag in Detailsoup.findAll('div', class_ = 'maintxt'):#详情页活动介绍正文
        ...
        for a in img_link:#遍历img字段
            ImgList.append("https://www.dpm.org.cn/gugongforum.html" + a['src'])#网页给的img链接没有"http://www.sxhm.com/"自己加上
...
dataframe.to_csv(r"故宫博物院活动.csv",sep=',')
