...
# 博物馆活动列表页网址
url = "http://www.coalmus.org.cn/html/list_1610.html"
...
for kk in links:#遍历详情页链接
    ...
    for tag in Detailsoup.findAll('div', class_ = 'maintxt'):#详情页活动介绍正文
        ...
        for a in img_link:#遍历img字段
            ImgList.append("http://www.coalmus.org.cn/html/list_1610.html" + a['src'])#网页给的img链接没有"http://www.sxhm.com/"自己加上
...
dataframe.to_csv(r"中国煤炭博物馆.csv",sep=',')
